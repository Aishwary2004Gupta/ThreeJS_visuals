...
function gameMake() {
  ...
  for (i = 0; i < num; i++) {
    ...
    grass.push(new Blade((i+1)/(num+1)*can.width, can.height, {x: Math.cos(ang), y: Math.sin(ang)}, randFrom(80,80), 0.3, 0.3))
  }
}
function gameMove() {
...
ctx.strokeStyle="white"
 ...
 ctx.strokeText("Use the mouse to push the grass around",can.width/2,30)
