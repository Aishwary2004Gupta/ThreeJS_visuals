...
function getBody(RAPIER, world) {
    ...
    function update() {
        ...
        rigid.addForce(dir.multiplyScalar(-1.4), true);
...
function getMouseBall(RAPIER, world) {
    ...
    // Setting up a RIGID BODY            //for interactive objects
    let bodyDesc = RAPIER.RigidBodyDesc.kinematicPositionBased().setTranslation(0, 0, 0)
    let mouseRigid = world.createRigidBody(bodyDesc);
    let dynamicCollider = RAPIER.ColliderDesc.ball(mouseSize * 3.0); //ball collider
